...
--- Command:top(windowFrame, screenFrame)
--- Method
...
obj.top = function(windowFrame, screenFrame)
  local newFrame
...
--- Command:bottom(windowFrame, screenFrame)
--- Method
--- Inspects current screen frame position, determines how to resize given frame
--- and calls corresponding resize method
---
--- Returns:
--- * A screenFrame to be rendered
obj.bottom = function(windowFrame, screenFrame)
  local newFrame
...
--- Command:left(windowFrame, screenFrame)
--- Method
--- Inspects current screen frame position, determines how to resize given frame
--- and calls corresponding resize method
---
--- Returns:
--- * A screenFrame to be rendered
obj.left = function(windowFrame, screenFrame)
  local newFrame
...
--- Command:right(windowFrame, screenFrame)
--- Method
--- Inspects current screen frame position, determines how to resize given frame
--- and calls corresponding resize method
---
--- Returns:
--- * A screenFrame to be rendered
obj.right = function(windowFrame, screenFrame)
  local newFrame
...
--- Command:maximize(windowFrame, screenFrame)
--- Method
--- Inspects current screen frame position, determines how to resize given frame
--- and calls corresponding resize method
---
--- Returns:
--- * A screenFrame to be rendered
obj.maximize = function(windowFrame, screenFrame)
  local newFrame = Resize:maximize(windowFrame, screenFrame)
  return newFrame
end
